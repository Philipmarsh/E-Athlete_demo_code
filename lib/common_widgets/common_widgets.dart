            ...
            child: Container(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(
                    vertical: widget.minLines == 1 ? 12 : 8),
                child: Row(
                  children: <Widget>[
                    widget.icon == null
                        ? Container()
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                      onHorizontalDragUpdate: (detail){
                        setState(() {
                          if((progress + detail.delta.dx/widget.width) >= 0.01 && (progress + detail.delta.dx/widget.width) <=0.95)
...
class _NumberPickerState extends State<NumberPicker> {
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        GestureDetector(child: Icon(Icons.remove, color: widget.color,),
          onTap: (){
        ...
        GestureDetector(child: Icon(Icons.add, color: widget.color,), onTap:(){
