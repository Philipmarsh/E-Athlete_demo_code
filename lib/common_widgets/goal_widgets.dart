...
//              widget.onChanged();
            ...
            onShortPressed: () {
              BlocProvider.of<GoalsBloc>(context).add(ChangeGoalsList(goal, 'Short Term'));
//              widget.onChanged();
              setState(() {});
            },
            onMediumPressed: () {
              BlocProvider.of<GoalsBloc>(context).add(ChangeGoalsList(goal, 'Medium Term'));
//              widget.onChanged();
              setState(() {});
            },
            onLongPressed: () {
              BlocProvider.of<GoalsBloc>(context).add(ChangeGoalsList(goal, 'Long Term'));
//              widget.onChanged();
              setState(() {});
            },
            onDeletePressed: () {
...
//              widget.onChanged();
      ...
      return ListView(
        ...
        children: <Widget>[] + longGoalsTiles + <Widget>[SizedBox(height: 60,)],
      );
    });
  }
}
...
class _FinishedListState extends State<FinishedList> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<GoalsBloc, GoalsState>(
      ...
      return ListView(
        controller: widget.scrollController,
        children: <Widget>[] + finishedTermGoalsTiles + <Widget>[SizedBox(height: 60,)],
      );
    });
  }
}
...
class _ShortTermListState extends State<ShortTermList> {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
        ...
        builder: (BuildContext context, box, widget1) {
          List shortTermGoals = box.get('shortTermGoals');
          List<Widget> shortTermGoalsTiles = [
            for (Goal goal in box.get('shortTermGoals'))
              GoalPageCard(
                goal: goal,
                onAchievedPressed: () {
                  BlocProvider.of<GoalsBloc>(context).add(GoalAchieved(goal));
      ...
      return ListView.builder(
        ...
        itemCount: shortTermGoals.length,
        controller: widget.scrollController,
        itemBuilder: (context, index){
          Goal goal = box.get('shortTermGoals')[index];
          return GoalPageCard(
            goal: goal,
            onAchievedPressed: () {
              BlocProvider.of<GoalsBloc>(context).add(GoalAchieved(goal));
...
class _MediumTermListState extends State<MediumTermList> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<GoalsBloc, GoalsState>(
      ...
      return ListView(
        controller: widget.scrollController,
        children: <Widget>[]+ mediumTermGoalsTiles + [SizedBox(height: 60,)],
      );
    });
  }
}
                      ...
                      children: <Widget>[
                       ...
                       Padding(
                         ...
                         return dropDownButtons;
                             ...
                             onSelected: (value){
                               if(value == 'Achieved'){setState(() {
                                 widget.onAchievedPressed();
                               });}
                               if(value == 'Not Achieved'){setState(() {
                                 widget.onNotAchievedPressed();
                               });}
                               if(value == 'Delete'){setState(() {
                                 widget.onDeletePressed();
                               });}
                               if(value == 'Move To Short'){setState(() {
                                 widget.onShortPressed();
                               });}
                               if(value == 'Move To Medium'){setState(() {
                                 widget.onMediumPressed();
                               });}
                               if(value == 'Move To Long'){setState(() {
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              ...
                              style:
                                  TextStyle(fontSize: 12, color: Color(0xffbec5ca)),
                            ),
                          ],
                        ),
//                          SizedBox(width: 30,),
